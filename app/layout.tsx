...
export const metadata = {
  title: "Vigneshwaran | Personal Portfolio",
  description: "Vigneshwaran is a full-stack web and mobile app developer.",
};
...
export default function RootLayout({ children }: { children: React.ReactNode; }) {
  return (
    <html lang="en" className="!scroll-smooth">
      <head>
        <meta name="google-site-verification" content="-4aKVPwaDjudLel2WUdl6HBH-3dQtfb7UMY-7z1BvCc" />
      </head>
